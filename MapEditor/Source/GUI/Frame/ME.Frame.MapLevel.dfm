object frMapLevel: TfrMapLevel
  ...
  object edTopPanel: TPanel
    ...
    Align = alTop
    BevelOuter = bvNone
    Caption = #1057#1087#1080#1089#1086#1082' '#1091#1088#1086#1074#1085#1077#1081' '#1082#1072#1088#1090#1099
    TabOrder = 0
    object edAddMapLevel: TcxButton
      ...
      Margins.Bottom = 2
      Align = alLeft
      Action = acAddMapLevel
      OptionsImage.Images = ImageList
      PaintStyle = bpsGlyph
      TabOrder = 0
    end
    object edEditMapLevel: TcxButton
      AlignWithMargins = True
      Left = 43
      Top = 2
      Width = 36
      ...
      Margins.Bottom = 2
      Align = alLeft
      Action = acEditMapLevel
      OptionsImage.Images = ImageList
      PaintStyle = bpsGlyph
      TabOrder = 1
    end
    object edDeleteMapLevel: TcxButton
      AlignWithMargins = True
      Left = 84
      Top = 2
      Width = 36
  ...
  object ActionList1: TActionList
    ...
    Left = 304
    Top = 152
    object acAddMapLevel: TAction
      Caption = #1044#1086#1073#1072#1074#1080#1090#1100' '#1091#1088#1086#1074#1077#1085#1100' '#1082#1072#1088#1090#1099
      ImageIndex = 0
    end
    object acEditMapLevel: TAction
      Caption = #1056#1077#1076#1072#1082#1090#1080#1088#1086#1074#1072#1090#1100' '#1091#1088#1086#1074#1077#1085#1100' '#1082#1072#1088#1090#1099
      ImageIndex = 1
    end
    object acDeleteMapLevel: TAction
      Caption = #1059#1076#1072#1083#1080#1090#1100' '#1091#1088#1086#1074#1077#1085#1100' '#1082#1072#1088#1090#1099
      ImageIndex = 2
    end
  end
  ...
  object F: TVirtualTable
    ...
    object FMapID: TIntegerField
      FieldName = 'MapID'
    end
    object FLevel: TIntegerField
      FieldName = 'Level'
    end
    object FPicture: TBlobField
      FieldName = 'Picture'
    end
  end
end
